    ...
    return (
        <input
            ...
            className={cn(
                ...
                'focus-visible:outline focus-visible:outline-purple-600',
                'aria-invalid:outline-red-500/20 dark:aria-invalid:outline-red-500/40 aria-invalid:border-red-500',
                className
            )}
            {...props}
        />
