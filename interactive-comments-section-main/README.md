...
![Design preview for the Interactive comments section coding challenge](./client/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](./client/README-template.md) file in this starter code.
