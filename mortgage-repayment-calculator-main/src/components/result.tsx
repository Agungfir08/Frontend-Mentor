...
export default function Result({
    ...
    return (
        <div className="p-6 lg:p-10 space-y-4 lg:space-y-6">
            ...
            <div className="px-4 py-5 lg:p-8 rounded-lg space-y-3.5 lg:space-y-8 bg-slate-950 border-t-2 border-lime">
                <div className="space-y-2.5">
                    <h3 className="font-medium text-slate-500 text-base">
                        Your monthly repayments
                    </h3>
                    <p className="text-lime text-4.5xl font-bold lg:text-5.5xl">
